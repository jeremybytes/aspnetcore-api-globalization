...
public class SunsetServiceControllerProvider : ISunsetServiceProvider
{
...
#pragma warning restore IDE1006 // Naming Styles
    ...
    public SunsetServiceControllerProvider(double latitude, double longitude)
    {
    ...
    {
        // Uses Current Culture for the URL route parameters
        // Controller service also uses Current Culture
        string endpoint = $"SolarCalculator/{latitude:F4}/{longitude:F4}/{date:yyyy-MM-dd}";
